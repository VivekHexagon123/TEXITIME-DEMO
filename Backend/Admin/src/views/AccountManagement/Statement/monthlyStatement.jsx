...
const BasicButton = () => {
  ...
  const dashSalesData = [
    {
      ...
      amount: `${OverallRides.total_sum ? OverallRides.total_sum : 0}`,
    ...
    },
    {
      ...
      amount: `${OverallRides.commission_sum ? OverallRides.commission_sum : 0}`,
      icon: 'bi bi-currency-rupee text-c-green',
    ...
    },
    {
      ...
      amount: `${OverallRides.total_requests ? OverallRides.total_requests : 0}`,
    ...
    },
    {
      ...
      amount: `${OverallRides.cancelled_requests ? OverallRides.cancelled_requests : 0}`,
  ...
  useEffect(() => {
    fetch('http://localhost:8000/api/users/monthlyridessatementcount')
  ...
  useEffect(() => {
    fetch('http://localhost:8000/api/users/allmonthlyridessatementcount')
      .then((response) => response.json())
      .then((data) => {
